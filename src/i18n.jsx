...
const zh = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: '可触摸无障碍复古音响',
      subtitle: 'STEREO · 视障友好桌面音响',
      tags: ['产品设计', '无障碍设计', 'Rhino / Keyshot'],
      desc: '为视障人群与复古音响爱好者设计的可触摸桌面音响：玻璃罩下的「水波节奏器」随音乐起伏，把声音转译成可见、可触摸的波纹——听觉与触觉融合，220mm 的体量单手可握。',
      ...
      detail: {
        ...
        overview: '传统家庭音响已经难以同时满足功能与审美的新要求，人们开始追求更有个性、更注重设计的听觉设备。这款复古音响在保留传统扬声功能的同时，把「听」延伸为「听 + 触」：玻璃罩下的水波节奏器随乐句起伏，灵感来自手纹按摩器的纹理、海上兴起的海浪与水滴入湖的涟漪。开关按键、切歌键、调节旋钮与节奏感应板集中在一块面板上，220mm 的体量适合办公、学习与休闲多种场景。',
        process: [
          { no: '01', title: '背景与人群', desc: '普通用户对音响品质与可玩性的需求日益增长，许多视障朋友也表现出对音乐的浓厚兴趣——无障碍成为设计的原点。' },
...
const en = {
  ...
  projects: [
    ...
    },
    {
      ...
      title: 'Touchable Barrier-free Retro Stereo',
      subtitle: 'STEREO · Vision-friendly desktop audio',
      tags: ['Product design', 'Inclusive design', 'Rhino / Keyshot'],
      desc: 'A desktop retro stereo meant to be experienced by touch: under the glass hood, a "water-ripple rhythm array" rises and falls with the music, turning sound into something visible and tangible — hearing and touch fused in a 220mm, one-hand-sized speaker.',
      ...
      detail: {
        ...
        overview: "Traditional home stereos no longer meet new expectations of function and taste. This retro stereo keeps the classic loudspeaker role and extends listening into touching: under the glass hood, a ripple-rhythm array rises and falls with the music, inspired by the texture of palm massage rollers, rising sea waves and raindrops on a lake. Switch, skip button, tuning knob and a rhythm-sensing pad sit on one panel, and the 220mm body fits work, study and break moments alike.",
        process: [
          { no: '01', title: 'Context & audience', desc: 'Demand for audio quality and playability keeps growing, and many blind users show a deep love for music — accessibility became the starting point.' },
